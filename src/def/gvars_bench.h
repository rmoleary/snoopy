...
#define		BENCH								/**< Define a funny 3D structure (see initflow.c) **/

//#define		INIT_VORTEX							/**< Add a 2D Kida vortex in the box. Assumes S=1. Requires b>a*/
#define		VORTEX_A					0.3		/**< x dimension of the vortex */
#define		VORTEX_B					0.4		/**< y dimension of the vortex */
...
#define		NOISE_CUT_LENGTH			0.4		/**< Wavelength over which the noise is applied */
